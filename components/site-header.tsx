...
function BrandLogo({ mobile = false }: { mobile?: boolean }) {
  return <Link className={`sfh-brand ${mobile ? 'sfh-brand--mobile' : ''}`} href="/" aria-label="SoftHaven Sri Lanka home"><span className="sfh-brand__teddy" aria-hidden="true"/><img src="/assets/soft-haven-logo-transparent.png" alt="SoftHaven Sri Lanka"/></Link>;
}
...
function RightTeddy() {
  return <div className="sfh-right-accent" aria-hidden="true"><div className="sfh-right-accent__note"><span>More</span><span>Than Toys</span><span>More Love ♡</span></div><div className="sfh-right-accent__teddy"/><span className="sfh-right-accent__heart">♡</span></div>;
}
